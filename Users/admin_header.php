<head>
    ...
    <link rel="stylesheet" href="admin_Assets/Style/Style.css"> 
	<link rel="stylesheet" href="admin_Assets/Style/sign-up.css">
	 <link rel="stylesheet" href="Assets/Style/index_style.css">
    <link rel="stylesheet" href="admin_Assets/Style/bootstrap-3.3.7-dist/css/bootstrap.min.css">
    <script src="admin_Assets/Style/jquery-3.1.1.min.js"></script>
    <script src="admin_Assets/Style/bootstrap-3.3.7-dist/js/bootstrap.min.js"></script> 
     
     <script  src="admin_Assets/Style/validate.js"></script> 
     ...
     <div class="header-wrapper" id="nav-1">
	    ...
	    <!--LOGO-->
	                   <a href="Index.php"><img id="Logo" class="img-rounded" src="admin_Assets/images/logo-bow.jpg"/></a>
                    </div>
	 <!--MENU BAR-->
                    <div id="menu" style=" background-color:black;">
                     <ul class="nav navbar-nav" >
                            <li><a class="active" href="bashboard.php">HOME</a></li>
