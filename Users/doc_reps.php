                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                       <div class="forms"> 
						   ...
						   <form method="post">
						   <p>DOWNLOAD APPOINTMENT SUMMARY</p>
                             
							   <button class="btn btn-danger" name="app_sum" type="submit">DOWNLOAD</button>
                           </form>
                    </div>    
                    </div>
                    ...
                    <div class="col-sm-3" id="land-img">
                       <div class="forms"> 
						   ...
						   <select name="date_cret" class="form-control">
							...
							<option  value="1">WITHIN THE WEEK</option> 
					...
					<div class="col-sm-4">
						<div  id="side-menu"> 
							...
							<div id="print_content" style="width: 1000px;"><br>
									<?php  $ObjUsersProc-> app_repts($MYSQL); ?>
								</div>
							</div>
						</div>
				</div>
